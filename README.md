...
2. Выбор признаков, PCA.Проклятие размерности.
   - 1 соревнование (лин.регрессия)
3. Работа с текстовыми данными. Bag-of-words, TF-IDF, Лемматизация.    (optional)****
   - Тест
4. Проблемы несбалансированных данных. Imblearn, метрики.:  
   - 2 соревнование (сентимент)
5. Калибрация моделей  
   - 2 домашка. решение задачи (3 недели)
6. Интерпретация моделей
   - проект или 3 домашка
7. Distribution shift
8. Semi-supervised learning, continous learning
9. Кластеризация 
...
Предварительная формула (без проекта): $ 50 * домашки + 5 * проверочная + 45 * соревнования $ 
Предварительная формула (с проектом): $ 20 * домашки + 25 * проект + 5 * проверочная + 40 * соревнования $ 
